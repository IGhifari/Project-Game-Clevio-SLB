...
import imgMog from "../../../assets/object/pekerjaan/guru.png";
import imgLtoo from "../../../assets/object/pekerjaan/petani.png";
import imgAtou from "../../../assets/object/pekerjaan/dokter.png";
...
export default function Level4() {
  ...
  const handleChoose = (card) => {
    if (card.name === "Guru") {
      ...
      localStorage.setItem(
        ...
        JSON.stringify(
          Math.max(5, Number(localStorage.getItem("pekerjaanLevelUnlocked") ) )
        )
      );
    } else {
      setResult("salah");
  ...
  const handleNextStage = () => {
    window.location.href = "/level5"; // Ganti jika ada stage berikutnya
  };
