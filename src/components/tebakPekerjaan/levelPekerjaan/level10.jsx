...
import imgPresiden from "../../../assets/object/pekerjaan/presiden.png";
...
export default function Level10() {
  ...
  const handleChoose = (card) => {
    if (card.name === "Presiden") {
      setResult("benar");
      // Unlock level berikutnya jika ada (tidak perlu jika ini level terakhir)
  ...
  const handleNextStage = () => {
    // Level terakhir, bisa redirect ke halaman selesai atau home
